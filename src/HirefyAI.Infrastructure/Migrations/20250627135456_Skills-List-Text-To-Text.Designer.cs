...
namespace HirefyAI.Infrastructure.Migrations
{
    ...
    [Migration("20250627135456_Skills-List-Text-To-Text")]
    partial class SkillsListTextToText
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("HirefyAI.Domain.Entities.Template", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Created = new DateTime(2025, 6, 27, 13, 54, 55, 984, DateTimeKind.Utc).AddTicks(1435),
                            CreatedBy = "System",
                            Description = "This is the default template for resumes.",
                            IsDeleted = false,
                            LastModified = new DateTime(2025, 6, 27, 13, 54, 55, 984, DateTimeKind.Utc).AddTicks(1441),
            ...
            modelBuilder.Entity("HirefyAI.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsDeleted = false,
                            LastName = "Admin",
                            RefreshToken = "2c8f265e-d4f0-4798-bb8a-6b91d6cd2499",
                            RefreshTokenExpireDate = new DateTime(2025, 6, 27, 13, 54, 55, 984, DateTimeKind.Utc).AddTicks(3003)
                        });
                });
